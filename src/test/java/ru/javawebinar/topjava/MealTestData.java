...
public class MealTestData {
    ...
    public static ResultMatcher contentJsonMeal(MealTo... expected) {
        return contentJsonMeal(List.of(expected));
    }

    public static ResultMatcher contentJsonMeal(Iterable<MealTo> expected) {
